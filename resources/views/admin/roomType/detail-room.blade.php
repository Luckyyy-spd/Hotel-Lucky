                ...
                <div class="form-group">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle mb-2">{{'Room Capacity : ' . '2' }}</h6>
                            <h6 class="card-subtitle mb-2">{{'Room Price : '}}@currency($data->price)</h6>
                            <h6 class="card-subtitle mb-2">{{'Room Available : ' . ' ' . $jumlahTersedia}}</h6>
                ...
                <div class="form-group">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @if ($jumlahTersedia == 0)
                                <div class="form-group">
                                    <label for="jumlah">Order Quantity</label>
